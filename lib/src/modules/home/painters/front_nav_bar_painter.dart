...
class FrontNavBarPainter extends CustomPainter {
  ...
  paint0Fill.shader = ui.Gradient.linear(Offset(size.width*0.6902820,size.height*0.9259259), Offset(size.width*0.6902820,0), <Color> [const Color(0xff262C51).withOpacity(1),const Color(0xff3E3F74).withOpacity(1)], <double> [0,1]);
  ...
  paint1Stroke.color = const Color(0xff7582F4).withOpacity(0.5);
  canvas.drawPath(path_1,paint1Stroke);

  Paint paint1Fill = Paint()..style=PaintingStyle.fill;
  paint1Fill.color = const Color(0xff262C51).withOpacity(1.0);
